...
function initPathTracingShaders() {
	...
	pathTracingUniforms.uTallBoxInvMatrix = {
		type: 'm4',
		value: new THREE.Matrix4(),
	};
	pathTracingUniforms.uShortBoxInvMatrix = {
		type: 'm4',
		value: new THREE.Matrix4(),
	};
...
function createPathTracingMaterial() {
	fileLoader.load('shaders/Cornell_Box_Fragment.glsl', function (shaderText) {
		...
		pathTracingMesh = new THREE.Mesh(
			pathTracingGeometry,
			pathTracingMaterial
		);
...
function updateVariablesAndUniforms() {
	// BOXES
	pathTracingUniforms.uTallBoxInvMatrix.value
		.copy(tallBoxMesh.matrixWorld)
		.invert();
	pathTracingUniforms.uShortBoxInvMatrix.value
		.copy(shortBoxMesh.matrixWorld)
		.invert();
